...
`;function p3(){return s.jsx(g3,{children:s.jsx("div",{children:s.jsx(wi,{heading:"Our Services",desc:"Comprehensive Cleaning Solutions Tailored to Meet Your Needs — From Homes to Offices and Everything in Between.",$headingSize:"2.5rem"})})})}const v3=P.main`
  animation: rT 0.5s ease;
`;function y3(){const l=ga({query:"(max-width: 767px)"}),u=ga({query:"(max-width: 1199px)"});C.useEffect(()=>{window.scrollTo(0,0)},[]);const c=l?"1fr":u?"repeat(2, 1fr)":"repeat(3, 1fr)";return s.jsxs(v3,{children:[s.jsx(p3,{}),s.jsx(e0,{$contentDirection:"column",$articleDisplay:"none",$navDisplay:"none",$scrollDisplay:"grid",$headingAlign:"center",$gridColumn:c,$topBorder:"1px solid var(--col-50)",$topPadding:"2.5rem",$headingWidth:"fit-content",$headingMargin:"2.5rem auto",$contentWidth:"100%"})]})}const b3=P.section`
  padding: 1.5rem;
  > div {
    max-width: 60.56rem;
    margin: 0 auto;
